    ...
    embeds: [
      new MessageEmbed(universalEmbed)
        ...
        .addFields({
          ...
          value:
            "Go to the Library Manager (Sketch -> Include Library -> Manage Libraries), search for the library, and install it. If it is already installed, try re-installing it through the library manager (Sketch -> include Library -> Manage Libraries).",
        }),
    ],
  },
  power: {
